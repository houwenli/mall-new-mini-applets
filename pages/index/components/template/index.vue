<template>
  <view data-desc='首页配置模版' class="applet-template-wrap">
    <view>
      <!-- 模板改为组件 -->
...
<script>
import wsfSeckill from '@/components/homePageConfig/wsf-seckill'
import wsfDistribution from '@/components/homePageConfig/wsf-distribution'
