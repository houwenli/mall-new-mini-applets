...
export default {
  ...
  computed: {
    ...
    getLeftStyle() {
      return {
        backgroundImage: `url(${this.config.leftBgImage})`,
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
        'background-size': '100% 100%',
        'background-color': `${this.config.leftBgColor}` || '#FFFFFF',
      };
    },

    getRightStyle() {
      return {
        backgroundImage: `url(${this.config.rightBgImage})`,
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
        'background-size': '100% 100%',
        'background-size': '100% 100%',
        'background-color': `${this.config.rightBgColor}` || '#FFFFFF',
      };
    },
  },
  methods: {
