<template>
  <view> 
    <view class="wrap" :class="{'cate-wrap': activeFCIndex != 0}" v-if="isOdd">
       <view class="applet-template-nav" :style="[navBackgroundStyle]" v-if="showSecondCateList && showSecondCateList.length > 0">             
        ...
        <view class="box-progress" v-if="showSecondCateList.length > 1 && isOdd">
          <view
            class="progress-outter"
          >
          <view            
              :class="[navCurrent == index ? 'progress-line' : 'progress-dot']"
              v-for="(item, index) in showSecondCateList"
              :key="index"
            >           
            </view>
          </view>
    ...
    <view class="wrap" v-else>
      <view class="applet-template-nav" :style="[navBackgroundStyle]" v-if="showSecondCateList && showSecondCateList.length > 0">
        <view class="index-nav" :style="{height: secondFateBoxHeight}">
...
export default {
  ...
  computed: {   
    ...
    secondFateBoxHeight() {
      console.log(this.showSecondCateList,'this.showSecondCateList');
      let height
