<template>
	...
	>
		...
		<view
			...
			:style="[style]"
		>
			<view v-if="title !== ''" class="wsf-mode-header" :style="{textAlign:titleTextAlign}">
				{{ title }}
				<view class="wsf-mode-header-close-btn" @click="close"></view>
			</view>
			...
			<view v-if="$slots.footer" class="wsf-mode-footer"><slot name="footer"></slot></view>
...
.wsf-mode-header-close-btn {
	height: 40rpx;
	width: 54rpx;
	position: absolute;
	right: 24rpx;
	top: 24rpx;
	background: url("https://wsjc-web-1301582899.cos.ap-guangzhou.myqcloud.com/wsf-mall/address/address-close-2x.png") center no-repeat;
