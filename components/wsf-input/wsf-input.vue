	...
	>
		...
		<view class="u-input__right-icon u-flex">
			...
			<view class="u-input__right-icon__clear u-input__right-icon__item" v-if="passwordIcon && type == 'password'">
				<u-icon size="32" :name="!showPassword ? 'mimayincang' : 'mimaxianshi'" custom-prefix="custom-icon" color="#c0c4cc" @click="showPassword = !showPassword"/>
				<!-- <u-icon name="mimayincang" custom-prefix="custom-icon" size="30" color="#888888"></u-icon> -->
			</view>
